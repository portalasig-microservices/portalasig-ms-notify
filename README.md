# portalasig-ms-notify

Microservicio de notificaciones de PortalAsig: renderizado de plantillas y despacho de correos (SMTP y eventos Kafka).
...
Estado actual: **91.8% líneas / 71.4% ramas** (15 tests).
